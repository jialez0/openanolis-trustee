...
BuildRequires:	cargo clang perl protobuf-devel git libtdx-attest-devel libgudev-devel openssl-devel tpm2-tss tpm2-tss-devel libsgx-dcap-quote-verify-devel
...
systemctl start kbs as as-restful rvps

%preun
if [ $1 == 0 ]; then #uninstall
  systemctl unmask kbs as as-restful rvps
  systemctl stop kbs as as-restful rvps
  systemctl disable kbs as as-restful rvps
